/*
 * MineStats.java - A Minecraft server status checker
...
public class MineStats {
    public static final String VERSION = "2.0.0"; // MineStats version
    ...
    public MineStats(String address)
    {
        this(address, DEFAULT_PORT, DEFAULT_TIMEOUT, Request.NONE);
    }

    public MineStats(String address, int port)
    {
        this(address, port, DEFAULT_TIMEOUT, Request.NONE);
    }

    public MineStats(String address, int port, int timeout)
    {
        this(address, port, timeout, Request.NONE);
    }

    public MineStats(String address, int port, int timeout, Request requestType)
    {
        setAddress(address);
        setPort(port);
        setTimeout(timeout);
    ...
    /*
     * Check if MineStats object data is present
     */
